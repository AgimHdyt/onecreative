<x-layout>
    @section('title', 'Landing Page - Jasa Pembuatan Website')

    @section('description', 'Kami menyediakan layanan pembuatan landing page dengan desain menarik dan responsif.')
                              ...
                              <div class="contact-info-area-2">
                                  ...
                                  <div class="contact-info-items mb-4">
                                      ...
                                      <div class="content">
                                          <p>Kirim Inbox</p>
                                          <h3>
                                              <a href="mailto:onecreative.id@gmail.com">onecreative.id@gmail.com</a>
                                          </h3>
                                      </div>
                                  </div>
...
@endif
                              <h2>Form Permintaan Penawaran</h2>
                              <p>
                                Silahkan isi form berikut sesuai dengan kebutuhan anda. <a href="/#biaya">Cek disini</a> untuk detail paket website. Anda juga bisa langsung menghubungi kami melalui telp/wa ke nomor <a href="https://wa.me/6285715007620">0857-1500-7620</a> atau mengirimkan email ke onecreative.id@gmail.com untuk permintaan dan pemesanan website.</p>
                              <form action="{{ route('send.message') }}" id="contact-form" method="POST" class="contact-form-items">
                                @csrf
                                  <div class="row g-4">
                                      ...
                                      <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                                          <div class="form-clt">
                                              <span>Telp/WA*</span>
                                              <input type="text" name="telp" id="telp" placeholder="Telp/WA">
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-lg-12 wow fadeInUp" data-wow-delay=".7s">
                                          <div class="form-clt">
                                              ...
                                              <select name="layanan" id="layanan" class="nice-select">
                                                <option value="">--pilih--</option>
                                                <option value="Pembuatan Website">Pembuatan Website</option>
                                                <option value="Redesign Website">Redesign Website</option>
                                                <option value="Perbaikan Website">Perbaikan Website</option>
                                                <option value="Maintenance Social Media">Maintenance Social Media</option>
                                      ...
                                      <div class="col-lg-7 wow fadeInUp" data-wow-delay=".9s">
                                          <button type="submit" class="theme-btn">
                                              Pesan Sekarang <i class="fa-solid fa-arrow-right-long"></i>
                                          </button>
                                      </div>
                                  </div>
                              </form>
      ...
      <div class="map-section">
          <div class="map-items">
              <div class="googpemap">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126834.74292150729!2d106.74800178614935!3d-6.573853365836198!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6849339c12dc7b%3A0x401e8f1fc28dd70!2sSukaraja%2C%20Kec.%20Sukaraja%2C%20Kabupaten%20Bogor%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1716055278554!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
          </div>
      </div>
